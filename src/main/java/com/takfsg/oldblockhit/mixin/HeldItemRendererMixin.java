...
public abstract class HeldItemRendererMixin {
	...
	private void useSwing(CallbackInfo ci) {
		if (field_1876.options.keyAttack.isPressed() && field_1876.options.keyUse.isPressed() && field_1876.world.getBlockState(field_1876.result.getBlockPos()).getBlock().getMaterial() != Material.AIR) {
